        ...
        sections: [
          {
            ...
            feature: {
              ...
              excerpt: '从 HCT 色彩空间到动态配色方案，深入理解 M3 的个性化色彩体系。',
              date: '2026-06-28',
              icon: 'palette',
              route: '/article/dynamic-color',
              image: '',
            },
            items: [
              {
                ...
                excerpt: 'M3 Expressive 设计语言深度解析：30 种字体样式、15 个组件强化与自适应布局革新。',
                date: '2026-06-27',
                icon: 'brush',
                route: '/article/m3-expressive',
                image: '',
              },
              {
                id: 'c-3',
